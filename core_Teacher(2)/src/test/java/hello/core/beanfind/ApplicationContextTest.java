...
public class ApplicationContextTest {
    ...
    @Test
    @DisplayName("애플리케이션 컨텍스트에 존재하는 모든 빈 출력")
    void findAllBean() {
        // 스프링 컨테이너에 등옭된 모든 빈의 이름을 문자열 배열로 저장
